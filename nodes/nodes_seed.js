...
const COUNTRIES = {
  // añadidos Etapa 2 (antes caían a fallback sin color ni posición):
  Israel:    {es:'Israel',      en:'Israel',    x:.58, y:.44, c:'#7dd3fc', cd:'#0369a1'},
  Australia: {es:'Australia',   en:'Australia', x:.88, y:.80, c:'#fcd34d', cd:'#b45309'},
  Europa:    {es:'Europa',      en:'Europe',    x:.47, y:.28, c:'#c4b5fd', cd:'#5b21b6'},
  India:     {es:'India',       en:'India',     x:.66, y:.55, c:'#fdba74', cd:'#c2410c'},
  Canada:    {es:'Canadá',      en:'Canada',    x:.18, y:.16, c:'#fca5a5', cd:'#b91c1c'},
...
const RAW_LINKS = [
  ...
  ['Zeiss','ASML',6,'Ópticas EUV pulidas a nivel atómico — monopolio','supply'],
  ...
  ['Nikon','Intel',5,'Escáneres DUV para capas no críticas','supply'],
  ...
  ['Ajinomoto','Ibiden',6,'Film ABF — monopolio sin sustituto','supply'],
  ...
  ['Arista','Microsoft',5,'Switches Ethernet — su mayor cliente','cloud'],
  ...
  ['Amazon','Snowflake',5,'AWS aloja la mayoría de sus cargas','cloud'],
  ...
  ['Microsoft','Snowflake',5,'Snowflake sobre Azure — segunda nube más grande de su mix','cloud'],
  ...
  ['Microsoft','OpenAI',6,'GPT-4/o1 corre exclusivamente en Azure (Microsoft es el único proveedor cloud)','cloud'],
  ...
  ['Astera','Nvidia',5,'Retimers PCIe 6.0 críticos para los NVL72 racks Blackwell','supply'],
  ...
  ['SKHynix','Nvidia',6,'Proveedor exclusivo HBM3e para H100/H200/B200 — monopolio de facto','supply'],
  ...
  ['SubCom','Alphabet',5,'Mayor cliente: cables Dunant, Grace Hopper, Firmina para Google','cloud'],
  ...
  ['SuperMicro','CoreWeave',5,'Principal proveedor de racks para los clusters de CoreWeave','cloud'],
  ...
  ['Apptronik','Amazon',1,'Apollo en piloto en centros de fulfillment Amazon GXO','deploy'],
  ['Palantir','Dell',2,'AIP Edge desplegado en dispositivos MetaConstellation con hardware Dell PowerEdge','deploy'],
  ['CrowdStrike','Dell',6,'Falcon desplegado como EDR estándar en todos los endpoints Dell Technologies','deploy'],
  ...
  ['Figure','Microsoft',1,'Figure 02 con OpenAI integrado desplegado en pilotos Microsoft manufacturing','deploy'],
  ...
  ['BMW','Figure',1,'BMW invierte y es cliente: piloto en Spartanburg tras la ronda','invest'],
  ...
  ['Nebius','Nvidia',6,'Nebius como cloud partner exclusivo de Nvidia en Europa — GPU clusters H100/H200','partner'],
...
// ── MACRO-SECTORES (Etapa 2, 2026-07): las 40 categorías agrupadas en 9 ──
// Diseñados para la piel NEXUS elegida (un color vivo por sector). La
// categoría fina (CATS) se conserva para el detalle al hacer zoom/clic.
const SECTORS9 = {
