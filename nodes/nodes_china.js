...
var NODES_CHINA = [
  ...
  {"id": "HorizonRobotics", "label": "Horizon Robotics", "ticker": "9660 · HKEX", "cat": "ai_auto", "port": "", "role": "Líder chino en chips de conducción asistida/autónoma (serie Journey), el 'Mobileye chino'; OPI en Hong Kong 2024.", "supplies": "SoCs Journey y stack de software ADAS a la mayoría de las marcas de autos chinas (BYD, Li Auto, y JV con Volkswagen/CARIAD).", "moat": "Mayor cuota de ADAS doméstico en el mercado de autos más grande del mundo + alianza Volkswagen (~US$2.400M). Riesgo: guerra de precios de los autos eléctricos chinos.", "loc": "Pekín, China", "country": "China", "growth": "🟢 Penetración ADAS en autos chinos en plena curva", "margin": null, "mkt": "9660.HK"},
  ...
  ,
  // Stubs: rellenan el mkt VACÍO de nodos chinos que YA existían (el merge
  // solo llena campos vacíos — nada más se toca). Símbolos Yahoo verificados.
  {"id": "AMEC", "mkt": "688012.SS"},
  {"id": "Naura", "mkt": "002371.SZ"},
  {"id": "Cambricon", "mkt": "688256.SS"}
];
