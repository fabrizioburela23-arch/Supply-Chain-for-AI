...
// ── Descripciones para 135 empresas que tenían ficha SIN desc
// (workflow de 9 agentes, 2026-07-12). Solo rellena huecos. ──
var DESC_FILL = {
 "IBMQuantum": "División cuántica de IBM que desarrolla procesadores de qubits superconductores (Eagle, Heron, Condor) y ofrece acceso vía nube con Qiskit. Importa porque tiene la hoja de ruta más creíble hacia la corrección de errores a escala y arrastra a todo el ecosistema de software y clientes empresariales.",
 "Rigetti": "Pionera de qubits superconductores con su propia fábrica (Fab-1), lo que le da control vertical sobre el diseño y fabricación de sus chips cuánticos. Importa como una de las pocas cuánticas cotizadas con capacidad de manufactura propia, aunque corre contra su caja para escalar antes de quedarse sin capital.",
 "IonQ": "Líder comercial en computación cuántica de iones atrapados, con sistemas accesibles en AWS, Azure y Google Cloud, y expansión agresiva vía adquisiciones (incluida redes cuánticas). Es la acción cuántica de referencia para el mercado: su cotización marca el sentimiento inversor de todo el sector.",
 "PsiQuantum": "Startup pre-IPO de computación cuántica fotónica que apuesta por saltar directo a un millón de qubits fabricando en procesos CMOS estándar (con GlobalFoundries). Importa porque si su apuesta funciona, evita la etapa intermedia NISQ y convierte la cuántica en un problema de manufactura de semiconductores; respaldada por contratos gubernamentales en Australia y EEUU.",
 "DWave": "Especialista en quantum annealing (recocido cuántico) para problemas de optimización, con miles de qubits en sus sistemas Advantage. Importa porque es la única empresa cuántica con clientes usando sus máquinas en producción comercial real hoy, no solo en investigación.",
 "Quantinuum": "Fusión de Honeywell Quantum y Cambridge Quantum, líder en iones atrapados con su sistema Helios y récords sostenidos de volumen cuántico (la métrica de calidad de qubits). Importa por tener los qubits de mayor fidelidad del sector y el respaldo mayoritario de Honeywell, con IPO esperada como catalizador del mercado cuántico.",
 "Pasqal": "Campeón cuántico francés (cofundado por el Nobel Alain Aspect) que construye procesadores de átomos neutros de 100 a 1.000 qubits, ya instalados en centros HPC europeos como GENCI y Jülich. Importa como la principal apuesta de soberanía cuántica de Europa continental.",
 "Bluefors": "Fabricante finlandés líder mundial de criostatos (refrigeradores) de dilución que enfrían los chips cuánticos a milikelvin. Importa como cuello de botella silencioso: casi toda la computación cuántica superconductora del mundo —IBM, Google, Rigetti— depende de su frío extremo.",
 "OxfordInstruments": "Grupo británico de instrumentación científica y criogenia (línea NanoScience) que provee refrigeradores de dilución y equipos de deposición/grabado a laboratorios cuánticos y de semiconductores. Importa como el principal competidor de Bluefors en la infraestructura de frío extremo, evitando un monopolio en ese eslabón.",
 "QuantumMachines": "Empresa israelí que fabrica los controladores OPX: la electrónica clásica que genera pulsos, lee y orquesta los qubits en tiempo real. Importa porque su capa de control es agnóstica a la modalidad de qubit y está instalada en la mayoría de laboratorios cuánticos del mundo, posicionándola como el estándar de facto de esa capa.",
 "FormFactor": "Número uno mundial en probe cards (tarjetas de prueba) para testear obleas de semiconductores, además de sistemas criogénicos y de medición. Importa como puente entre semis avanzados y cuántica: prueba los chips de los grandes fabricantes de lógica y memoria (HBM incluida) y provee criostatos a labs cuánticos.",
 "Synopsys": "Líder mundial en software EDA (diseño automatizado de chips) e IP de silicio; tras absorber Ansys (2025) domina también la simulación multifísica. Importa porque ningún chip avanzado —de NVIDIA a TSMC— se diseña sin sus herramientas: es un peaje obligatorio de toda la cadena, y por eso arma clave del control de exportaciones de EEUU hacia China.",
 "Cadence": "Segundo gigante del duopolio EDA, fuerte en diseño analógico/mixto, verificación y placas, más aceleradores de emulación (Palladium) usados para validar chips de IA antes de fabricarlos. Importa porque junto a Synopsys controla las herramientas sin las que no existe ningún diseño de silicio moderno.",
 "ARM": "Diseña y licencia la arquitectura de CPU que domina móviles y avanza en datacenter: los Grace de NVIDIA, Graviton de AWS y Axion de Google son núcleos ARM. Importa porque es el sistema nervioso del cómputo que acompaña a las GPUs de IA; propiedad mayoritaria de SoftBank, su modelo de regalías lo hace omnipresente y neutral a la vez.",
 "SiemensEDA": "Tercer jugador del oligopolio EDA (la antigua Mentor Graphics, comprada por Siemens en 2017), fuerte en verificación física (Calibre) y test. Importa porque su herramienta Calibre es el estándar de facto para el signoff físico previo a fabricación en casi todas las foundries, incluida TSMC.",
 "MitsuiChemicals": "Grupo químico japonés que domina la producción de pellicles EUV: la membrana ultrafina que protege las máscaras de litografía de partículas durante la exposición. Es proveedor casi único de este consumible para ASML y los fabricantes de chips avanzados; sin pellicles, el rendimiento de los nodos EUV cae.",
 "Toto": "Fabricante japonés de cerámica avanzada (conocido por sanitarios) que produce los mandriles electrostáticos (ESC) que sujetan las obleas dentro de las cámaras de proceso. Su cerámica de precisión es un insumo silencioso pero crítico para Applied Materials, Lam y TEL: pocos en el mundo la fabrican con esa pureza.",
 "Hoya": "Óptico japonés que forma duopolio con AGC en mask blanks EUV, el sustrato de vidrio de bajísima expansión térmica sobre el que se escribe cada fotomáscara. Sin sus blanks no hay máscaras EUV, y sin máscaras no hay chips de vanguardia: es un cuello de botella aguas arriba de TSMC, Samsung e Intel.",
 "ASML": "Único fabricante mundial de máquinas de litografía EUV (~380 M$ cada una las High-NA); ningún chip por debajo de 7nm se produce sin ellas. Es el monopolio más absoluto de toda la cadena y el arma central del control de exportaciones a China; sus clientes clave son TSMC, Samsung e Intel.",
 "AMAT": "Mayor proveedor mundial de equipos de fabricación de semiconductores, con el portafolio más amplio: deposición, implantación iónica, CMP, inspección. Su escala y amplitud lo hacen indispensable para toda fab del planeta, de TSMC a los fabricantes chinos de nodos maduros.",
 "Lam": "Líder mundial en grabado por plasma (etch) y deposición para estructuras verticales; sus equipos son indispensables para NAND 3D y para el apilado de memoria HBM que alimenta las GPUs de IA. Junto con AMAT y TEL forma el oligopolio de equipos de proceso; SK Hynix, Samsung y Micron dependen de él.",
 "KLA": "Dominante en inspección y metrología de obleas: sus equipos detectan defectos nanométricos y son la clave para subir el rendimiento (yield) de un nodo nuevo. Cuanto más caros los chips (EUV, HBM), más inspección se necesita — por eso tiene los mejores márgenes de todo el sector de equipamiento.",
 "TEL": "Tokyo Electron tiene un cuasi-monopolio (~90%) en pistas de fotorresistencia (coater/developer), el equipo que aplica y revela el químico fotosensible acoplado a cada escáner de ASML. Cada litografía EUV necesita una pista TEL al lado; es además top-4 mundial en etch y deposición.",
 "ASMInt": "Pionero y líder mundial en deposición de capas atómicas (ALD), la técnica que deposita películas de un átomo de espesor imprescindible para transistores gate-all-around de 2nm. A medida que los chips se hacen 3D, su contenido por oblea crece más rápido que el mercado.",
 "Nikon": "Segundo fabricante mundial de litografía DUV tras perder la carrera EUV frente a ASML; hoy se especializa en escáneres ArF/i-line para nodos maduros. Relevante porque China, bloqueada del EUV, es un comprador natural de su litografía menos restringida.",
 "Canon": "Fabricante japonés de litografía DUV para nodos maduros y única empresa que comercializa nanoimprint (NIL), una técnica que estampa el patrón por contacto y podría lograr resoluciones tipo EUV a una fracción del coste. Es la única apuesta disruptiva contra el monopolio de ASML.",
 "Disco": "Cuasi-monopolio (~80%) mundial en máquinas de corte (dicing) y rectificado (grinding) de obleas. Es crítico para HBM: adelgazar cada die de memoria a ~30 micras para apilarlo en 12-16 capas solo se hace con equipos Disco; SK Hynix y Samsung no tienen alternativa real.",
 "Screen": "Líder mundial (~40-50%) en equipos de limpieza húmeda de obleas, el paso que más veces se repite en una fab (cientos de veces por oblea). Un defecto de limpieza arruina todo el proceso posterior, lo que hace a Screen un proveedor imprescindible y poco sustituible para TSMC, Samsung y las fabs chinas.",
 "Naura": "Mayor fabricante chino de equipos de semiconductores (etch, deposición, hornos, limpieza) y buque insignia de la sustitución doméstica impulsada por Pekín tras los controles de exportación de EE.UU. Sus clientes clave son SMIC, YMTC y CXMT, que lo priorizan por mandato estratégico aunque vaya generaciones por detrás de AMAT/Lam.",
 "AMEC": "Especialista chino en grabado por plasma fundado por un ex-ejecutivo de Applied Materials; es el único equipo chino que llegó a calificar en las líneas avanzadas de TSMC. Campeón nacional del etch, es la mejor carta de China para reemplazar a Lam Research bajo las sanciones.",
 "ShinEtsu": "Mayor productor mundial de obleas de silicio de 300mm (además de PVC y siliconas), con ~30% del mercado global. Es literalmente el punto de partida físico de todo chip avanzado: TSMC, Samsung e Intel dependen de sus obleas ultra-puras, un proceso con décadas de know-how casi imposible de replicar.",
 "SUMCO": "Segundo fabricante mundial de obleas de silicio y el único pure-play grande del sustrato base. Junto con Shin-Etsu forma un duopolio japonés que controla más de la mitad de las obleas de 300mm del planeta; sus contratos de largo plazo con las foundries anclan la capacidad futura de toda la industria.",
 "Siltronic": "Único fabricante europeo relevante de obleas de silicio (escindida de Wacker Chemie), tercer-cuarto proveedor global. Es la carta de 'soberanía de materiales' de Europa: sin ella, el continente dependería al 100% de Asia para el sustrato de sus chips.",
 "GlobalWafers": "Tercer-cuarto productor mundial de obleas, creado a base de adquisiciones (SunEdison, Topsil) y el más diversificado geográficamente, con fábricas en Asia, Europa y EE.UU. (nueva planta en Texas con apoyo del CHIPS Act). Es la opción de 'obleas fuera de Japón' para clientes que buscan resiliencia.",
 "Ajinomoto": "Empresa japonesa de alimentos (inventora del glutamato) que posee el monopolio de facto del film aislante ABF, derivado de sus aminoácidos y esencial para el empaquetado de todo CPU y GPU avanzados. Cuando el ABF escasea —como en 2021— se frena la producción de chips de Intel, AMD y NVIDIA; es el cuello de botella más inesperado de la cadena.",
 "JSR": "Líder mundial en fotorresistencias EUV, los químicos fotosensibles que graban los patrones más finos en los chips. Su compra por el fondo estatal japonés JIC en 2023-24 la convirtió oficialmente en activo estratégico nacional: sin sus resists, la litografía EUV de ASML no imprime nada.",
 "Entegris": "Especialista estadounidense en pureza para fabs: filtros, contenedores FOUP para obleas, sistemas de manejo de químicos y materiales avanzados (reforzada con la compra de CMC Materials). En nodos de 3nm una sola partícula arruina un chip, así que cada fab de vanguardia es cliente cautivo de su ecosistema de contaminación cero.",
 "TokyoOhka": "Mayor fabricante mundial de fotorresistencias por volumen y, junto con JSR, la otra mitad del duopolio japonés en resists EUV. Proveedor crítico de TSMC y Samsung; su dominio explica por qué el control japonés de químicos de litografía es un arma geopolítica.",
 "MerckKGaA": "Conglomerado alemán de farma y química cuya división Electronics (reforzada con Versum e Intermolecular) es top-3 mundial en materiales para semiconductores: gases de especialidad, precursores de deposición y químicos de planarización. Es el principal proveedor europeo de la 'química invisible' que consume cada fab de TSMC, Samsung e Intel.",
 "Linde": "Mayor empresa de gases industriales del mundo; suministra el nitrógeno ultra-puro, helio, argón y gases de especialidad que una fab avanzada consume en volúmenes enormes y de forma continua. Suele construir plantas de gases on-site junto a cada nueva fab (TSMC Arizona, Samsung Taylor), lo que la convierte en socio de infraestructura de por vida, no en proveedor sustituible.",
 "AirLiquide": "Segundo gasista industrial mundial y líder en precursores para deposición de capa atómica (ALD) a través de su unidad de materiales avanzados. Como Linde, se integra físicamente en las fabs con plantas dedicadas; su química de precursores es clave para las estructuras 3D (gate-all-around, memoria apilada) de los nodos más avanzados.",
 "TSMC": "La fundición taiwanesa que fabrica más del 90% de los chips de vanguardia del mundo: todos los aceleradores de NVIDIA, los chips de Apple y los de AMD salen de sus fabs. Es el punto único de fallo de toda la economía de la IA y el corazón del riesgo geopolítico de Taiwán; su ventaja en rendimiento de nodos avanzados y empaquetado CoWoS no tiene sustituto a corto plazo.",
 "Samsung": "Gigante coreano integrado (IDM): líder histórico en memoria DRAM/NAND, jugador clave en HBM para IA y la única foundry que compite con TSMC en nodos de 3nm/2nm. Es el 'plan B' del mundo si Taiwán falla, y su negocio de memoria la hace indispensable para los aceleradores de IA aunque su foundry vaya detrás en yield.",
 "Intel": "El IDM estadounidense histórico, en plena reconversión hacia el modelo foundry (Intel Foundry, nodo 18A) con miles de millones del CHIPS Act y participación directa del gobierno de EE.UU. Importa porque es la única esperanza realista de fabricación de vanguardia en suelo estadounidense; su éxito o fracaso define la estrategia de seguridad de chips de Washington.",
 "GF": "Principal foundry estadounidense (origen: fabs escindidas de AMD, controlada por Mubadala) especializada en nodos maduros y tecnologías diferenciadas: RF, silicio sobre aislante, automotriz y defensa. Abandonó la carrera de vanguardia, pero es proveedor acreditado del Pentágono y fabrica los chips 'aburridos' sin los cuales autos, satélites y sistemas militares no funcionan.",
 "SMIC": "La mayor foundry de China (nodos maduros y 7nm sin EUV para Huawei). Es la pieza central de la autosuficiencia china en chips: pese a estar en la lista de entidades de EEUU, fabrica los Ascend de HiSilicon y sostiene todo el ecosistema fabless chino.",
 "Rapidus": "Foundry japonesa respaldada por el Estado y ocho conglomerados (Toyota, Sony, SoftBank) que busca fabricar chips de 2nm en Hokkaido hacia 2027 con tecnología GAA licenciada de IBM. Es la apuesta de Japón por volver a la vanguardia y ofrecer a Occidente una alternativa a TSMC fuera de Taiwán.",
 "TexasInstruments": "Líder mundial en chips analógicos y de gestión de energía, con decenas de miles de productos fabricados en sus propias fabs de 300mm en EEUU. Sus chips de potencia y conversión de señal están en prácticamente cada servidor, data center y sistema industrial: bajo perfil pero omnipresentes.",
 "Infineon": "El mayor fabricante mundial de semiconductores de potencia, líder en SiC y GaN. Sus módulos de alimentación de 800 VDC son clave para los racks de IA de nueva generación (colabora con Nvidia en la arquitectura de potencia de los data centers) además de dominar en automoción.",
 "onsemi": "Especialista estadounidense en carburo de silicio (SiC) y potencia inteligente, con integración vertical desde el sustrato. Sus chips alimentan vehículos eléctricos (cliente clave: Tesla y OEMs globales) y la infraestructura de energía de los data centers de IA.",
 "Nvidia": "Diseñador de las GPUs que entrenan y sirven prácticamente toda la IA moderna (Hopper, Blackwell, Rubin), con el moat de software CUDA y redes NVLink/InfiniBand. Es el nodo más valioso de la cadena: su demanda arrastra a TSMC, SK Hynix (HBM) y toda la infraestructura de data centers.",
 "AMD": "El único rival serio de Nvidia en aceleradores de IA (serie Instinct MI300/MI350) y de Intel en CPUs x86 (EPYC domina en servidores). Fabless apoyado en TSMC; sus clientes clave son los hyperscalers que buscan una segunda fuente frente al monopolio de Nvidia.",
 "Qualcomm": "Líder mundial en SoCs y módems para smartphones premium (Snapdragon) con un enorme negocio de licencias de patentes. Se expande hacia PCs con Arm y anunció chips de inferencia para data centers (AI200/AI250), buscando diversificarse más allá del móvil.",
 "Apple": "Diseña los chips serie A y M de sus iPhones y Macs, referentes en rendimiento por vatio. Importa en la cadena porque es el mayor cliente de TSMC y suele reservar en exclusiva cada nuevo nodo puntero, financiando de facto el avance de la vanguardia.",
 "Cambricon": "La 'Nvidia china': fabless de aceleradores de IA (línea Siyuan) que se disparó al convertirse en beneficiario directo de los vetos de EEUU a los chips americanos en China. Su cliente natural son los hyperscalers y el Estado chinos obligados a comprar hardware doméstico.",
 "HiSilicon": "La filial de diseño de chips de Huawei; su acelerador Ascend 910B/910C es la alternativa china más creíble a Nvidia, fabricado en SMIC pese a las sanciones. Es la punta de lanza del stack de IA soberano chino, de silicio a modelo.",
 "SKHynix": "Proveedor número 1 mundial de memoria HBM, el componente más escaso y crítico de los aceleradores de IA. Socio prioritario de Nvidia (HBM3E y HBM4 para Blackwell/Rubin): sin su memoria apilada, las GPUs de IA no pueden fabricarse.",
 "Micron": "El único gran fabricante de memoria occidental (DRAM, NAND y HBM), con sede en EEUU y fabs subsidiadas por el CHIPS Act. Tercero en HBM tras SK Hynix y Samsung, es la opción estratégica de Occidente para no depender de Corea en memoria de IA.",
 "Kioxia": "La empresa japonesa que inventó la memoria Flash NAND (como Toshiba) y hoy es el segundo productor mundial, con fabs conjuntas con SanDisk. Su NAND alimenta los SSDs que almacenan los datasets masivos de la IA.",
 "SanDisk": "Fabricante puro de NAND y SSDs enterprise, escindido de Western Digital en 2025. Comparte fabs con Kioxia en Japón (joint venture) y es un jugador clave del duopolio-alianza que abastece el almacenamiento flash de los data centers.",
 "YMTC": "Fabricante estatal chino de memoria NAND 3D, campeón nacional de Pekín pese a estar en la Entity List de EE.UU. Importa porque demuestra hasta dónde llega la autosuficiencia china: logró NAND de ~294 capas usando equipos domésticos, presionando precios y siendo termómetro de la eficacia de las sanciones.",
 "Ibiden": "Fabricante japonés líder de sustratos ABF de alta gama, la 'placa base' que conecta el chip con el PCB. Es proveedor crítico de Intel y de los paquetes de GPUs de IA de NVIDIA: sin sus sustratos de gran tamaño y muchas capas, los aceleradores no se pueden ensamblar.",
 "Unimicron": "Segundo fabricante mundial de sustratos ABF, con sede en Taiwán. Junto a Ibiden forma el cuello de botella silencioso del empaquetado de chips de IA: la escasez de sustratos ABF ya frenó entregas de GPUs en el pasado y su capacidad marca el ritmo de expansión de TSMC y NVIDIA.",
 "ASE": "Mayor OSAT del mundo (empaquetado y test subcontratado), con sede en Taiwán. Absorbe el desborde de empaquetado avanzado (CoWoS, fan-out) que TSMC no puede cubrir, siendo pieza clave para que NVIDIA y AMD escalen la producción de aceleradores de IA.",
 "Advantest": "Líder japonés en equipos de test automatizado (ATE) de semiconductores, dominante en test de SoCs avanzados y memoria HBM. Cada GPU de IA y cada pila HBM pasa por sus testers, por lo que su cartera de pedidos es un indicador adelantado del ciclo de chips de IA.",
 "Amkor": "Segundo OSAT mundial y el único con base estadounidense, con nueva planta de empaquetado avanzado en Arizona junto a las fabs de TSMC. Importa como la alternativa 'onshore' para cerrar el eslabón de empaquetado que hoy vive casi todo en Taiwán.",
 "Teradyne": "La otra mitad del duopolio mundial de test de chips (ATE) junto a Advantest, fuerte en test de procesadores, ASICs y almacenamiento; además posee Universal Robots en robótica colaborativa. Todo silicio complejo debe testearse en máquinas suyas o de Advantest, un moat de duopolio casi perfecto.",
 "Besi": "Empresa holandesa líder en equipos de hybrid bonding, la técnica que une chiplets y memoria cobre contra cobre sin soldadura. Es la puerta de entrada al empaquetado de próxima generación (HBM4, SoIC de TSMC): su alianza con Applied Materials la coloca en el centro del roadmap 3D de los chips de IA.",
 "Arista": "Líder en switches Ethernet de 400G/800G para data centers, con su sistema operativo EOS como diferenciador. Es el gran apostador de Ethernet frente a InfiniBand de NVIDIA en redes de entrenamiento de IA, con Microsoft y Meta como clientes ancla.",
 "Cisco": "Gigante histórico del networking empresarial que la IA reactivó gracias a su ASIC Silicon One y a acuerdos con hyperscalers y con Arabia Saudí (HUMAIN). Importa como segunda fuente de switching de IA y por su enorme base instalada empresarial, aunque llega por detrás de Arista y Broadcom.",
 "Broadcom": "Diseña los ASICs de IA a medida de los hyperscalers (TPU de Google, aceleradores de Meta y OpenAI) y domina el silicio de switching Ethernet (Tomahawk/Jericho). Es la principal alternativa estructural a NVIDIA: quien no quiere depender de GPUs compra silicio custom de Broadcom.",
 "Marvell": "Diseñador de ASICs custom (Trainium de Amazon), DSPs ópticos y silicio fotónico para interconexión de data centers. Importa como el número dos del silicio a medida tras Broadcom y como dueño clave de la electrónica que ilumina los enlaces ópticos entre racks de IA.",
 "Credo": "Especialista en cables eléctricos activos (AEC) y SerDes que conectan servidores y switches dentro del rack a 400/800G con menos energía que la óptica. Su conectividad 'invisible' se volvió estándar en los racks de IA de hyperscalers como Amazon y Microsoft, disparando su crecimiento.",
 "Astera": "Diseña retimers, switches PCIe 6/CXL y conectividad para que GPUs, CPUs y memoria se comuniquen sin errores dentro del servidor de IA. Cada plataforma de NVIDIA y de los hyperscalers necesita sus chips de señal; es de las pocas empresas nacidas específicamente para el rack de IA.",
 "Coherent": "Uno de los mayores fabricantes de transceptores ópticos 800G/1.6T y láseres (VCSEL, fotónica de InP) que interconectan los clusters de IA entre racks. La demanda de óptica crece más rápido que la de GPUs por cluster, y Coherent es proveedor central de esa capa junto a Innolight y Eoptolink.",
 "Ciena": "Fabricante estadounidense de sistemas ópticos coherentes DWDM para transmisión de larga distancia y sus chips WaveLogic. Es el líder en interconexión entre data centers (DCI), el tráfico que explota cuando los hyperscalers reparten el entrenamiento de IA entre múltiples campus.",
 "Lumentum": "Fabricante de láseres EML/CW y transceptores ópticos para datacom, componentes esenciales de los enlaces de 800G en redes de IA. Compite con Coherent en el suministro de láseres a los grandes ensambladores de transceptores y apuesta por la óptica co-empaquetada (CPO), la próxima generación de conectividad dentro del rack.",
 "Innolight": "Empresa china número 1 mundial en transceptores ópticos de 800G y 1.6T, los módulos que conectan las GPUs entre racks. Es proveedor crítico de Nvidia y de los hyperscalers, lo que la convierte en un punto sensible de la cadena ante restricciones EEUU-China.",
 "Amphenol": "Fabricante estadounidense de conectores, cables de cobre de alta velocidad y backplanes presentes en prácticamente cada rack de IA (incluidos los sistemas NVLink de Nvidia). Su amplitud de catálogo y su posición en cada interconexión física del data center le dan un moat de 'peaje' silencioso.",
 "Vertiv": "Especialista estadounidense en energía, enfriamiento (incluido líquido) e infraestructura física para data centers: el 'electricista y plomero' de la IA. Socio de referencia de Nvidia para los diseños térmicos de sus racks de alta densidad, es uno de los ganadores más directos del capex de hyperscalers.",
 "MPWR": "Diseñador fabless estadounidense de chips de gestión de energía (VRMs/módulos de potencia) que alimentan las GPUs de los servidores de IA. Su tecnología de integración le dio una posición dominante en las plataformas de Nvidia, donde cada generación de GPU exige entregar más corriente en menos espacio.",
 "Eaton": "Proveedor de la columna vertebral eléctrica del data center: switchgear, UPS, distribución de potencia y transformadores. Con plazos de entrega de años en equipos eléctricos, su cartera de pedidos lo convierte en cuello de botella y ganador estructural del boom de capacidad de IA.",
 "Schneider": "Líder global francés en infraestructura eléctrica y de cooling para data centers (compró Motivair para reforzar enfriamiento líquido). Su software EcoStruxure y su alcance mundial lo hacen socio estándar de hyperscalers y operadores de colocation.",
 "GEVernova": "Fabricante estadounidense de turbinas de gas y equipos de red eléctrica, escindido de GE. Es el ganador más directo del boom de demanda eléctrica de los data centers: sus turbinas están vendidas hasta años vista y a menudo son la única forma rápida de añadir generación firme para nuevos campus de IA.",
 "Constellation": "Operador de la mayor flota nuclear de EE.UU. (~22 GW), que vende energía firme 24/7 libre de carbono directamente a hyperscalers — incluido el acuerdo con Microsoft para reabrir Three Mile Island. Es el proxy bursátil por excelencia de 'la IA necesita nucleares'.",
 "SiemensEnergy": "Fabricante alemán de turbinas de gas, sistemas HVDC y transformadores, escindido de Siemens. Sus equipos de red son el cuello de botella de la expansión eléctrica global: sin sus transformadores y convertidores HVDC no se conectan nuevos data centers ni renovables.",
 "DeltaElectronics": "Fabricante taiwanés de fuentes de poder, módulos de potencia y soluciones térmicas que alimentan los racks GB300 de Nvidia; socio clave en la transición a arquitecturas de 800 VDC. Domina la electrónica de potencia de alta eficiencia que convierte megavatios de red en corriente para GPUs.",
 "SubCom": "Uno de los tres grandes instaladores mundiales de cables submarinos de fibra óptica, con sede en EE.UU. y flota propia de barcos cableros. Tiende los cables transoceánicos de Google, Meta y del gobierno estadounidense — infraestructura estratégica por la que fluye casi todo el tráfico intercontinental de datos.",
 "NEC": "Conglomerado japonés de TI y telecomunicaciones, y uno de los tres grandes fabricantes/instaladores de cables submarinos del mundo (con su unidad OCC). Es la opción 'aliada' para los cables del Indo-Pacífico donde EEUU y Japón vetan a proveedores chinos como HMN Tech.",
 "ASN": "Alcatel Submarine Networks opera la mayor flota de barcos cableros del mundo y fabrica e instala cables submarinos de extremo a extremo. Francia la nacionalizó (compra a Nokia) por considerarla activo estratégico: quien tiende y repara los cables controla la resiliencia del internet global.",
 "Lumen": "Operador de telecomunicaciones dueño de la mayor red de fibra intercontinental de EE.UU., que está vendiendo capacidad de fibra oscura a hyperscalers (acuerdo multimillonario con Microsoft) para interconectar centros de datos de IA. Importa porque el entrenamiento distribuido exige enlaces de altísimo ancho de banda entre campus, y Lumen posee los derechos de paso y conductos ya tendidos.",
 "Corning": "Mayor fabricante mundial de fibra óptica y vidrio especializado; su fibra es el medio físico de los corredores de datos que unen los centros de IA de los hyperscalers (contratos dedicados con Lumen y AT&T). Su moat son décadas de proceso de manufactura de vidrio imposibles de replicar rápido.",
 "Dell": "Fabricante de servidores de IA (línea PowerEdge XE con GPUs NVIDIA) con el mayor canal de ventas enterprise del mundo; ensambló buena parte de los clústeres de xAI/Colossus. Importa como puente entre NVIDIA y las empresas tradicionales que no compran directamente a ODMs.",
 "HPE": "Fabricante de servidores de IA y dueño de Cray, líder en supercomputación (sistemas exascale como Frontier y El Capitan) y en interconexión Slingshot; compró Juniper para reforzar redes. Importa por su posición única en HPC gubernamental y cloud soberano.",
 "Lenovo": "Mayor fabricante de PCs del mundo y proveedor creciente de servidores de IA con refrigeración líquida (Neptune); opera como puente comercial entre la cadena china y los mercados occidentales. Importa porque su escala de manufactura y posición geopolítica ambigua lo hacen sensible a controles de exportación.",
 "Foxconn": "Mayor ensamblador electrónico (EMS) del mundo; los servidores de IA (racks GB200/GB300 para NVIDIA y hyperscalers) ya rivalizan con el iPhone como su motor de ingresos. Es el cuello de botella de ensamblaje final: gran parte de los racks NVL del mundo salen de sus plantas en Taiwán, México y Texas.",
 "SuperMicro": "Pionero en servidores GPU con refrigeración líquida y el ensamblador más rápido en llevar nuevos chips NVIDIA al mercado; cliente clave de labs de IA y neoclouds. Importa por su velocidad de diseño, aunque arrastra riesgo regulatorio tras acusaciones contables y la salida de su auditor.",
 "Quanta": "ODM taiwanés líder en servidores de IA: a través de QCT fabrica racks GB200/GB300 directamente para Meta, Microsoft y AWS sin marca intermedia. Importa porque los hyperscalers diseñan sus propios servidores y Quanta es quien los materializa a escala.",
 "Celestica": "ODM/EMS canadiense que fabrica servidores de IA y switches de red 800G para hyperscalers (Google entre sus mayores clientes). Importa porque el networking del centro de datos es el segundo cuello de botella tras las GPUs, y su acción se ha multiplicado con el boom.",
 "Jabil": "EMS estadounidense diversificado que fabrica racks de IA, componentes de fotónica y sistemas de refrigeración líquida en EE.UU. y México. Importa como opción de manufactura 'onshore' para hyperscalers que buscan reducir dependencia de Taiwán.",
 "Microsoft": "Hyperscaler número dos (Azure), mayor inversor de OpenAI y ahora también cliente/socio de Anthropic; desarrolla su propio silicio (Maia). Importa porque su capex de decenas de miles de millones por trimestre es una de las mayores fuentes de demanda de toda la cadena de GPUs, redes y energía.",
 "Amazon": "Mayor nube del mundo (AWS) e inversor ancla de Anthropic (~$8B); diseña sus propios chips de IA (Trainium/Inferentia vía Annapurna) y construye los clústeres Rainier para entrenar a Claude. Importa como la única alternativa a escala frente al monopolio de NVIDIA en entrenamiento.",
 "Alphabet": "El único hyperscaler verticalmente integrado: nube (GCP), modelo frontier propio (Gemini) y chip propio (TPU, fabricado con Broadcom). Importa porque las TPUs son la prueba de que se puede entrenar IA de frontera sin NVIDIA, y ahora las alquila incluso a rivales como Anthropic.",
 "Oracle": "Nube empresarial (OCI) convertida en socio central del proyecto Stargate de OpenAI, con contratos de cómputo por cientos de miles de millones de dólares. Importa porque apostó su balance a construir gigavatios de capacidad GPU para un cliente casi único — concentración extrema de riesgo y de upside.",
 "CoreWeave": "Neocloud líder: alquila cómputo GPU puro a labs de IA (OpenAI, Microsoft como clientes ancla) con NVIDIA como inversor y proveedor preferente. Importa como el intermediario que convierte deuda respaldada por GPUs en capacidad de entrenamiento disponible más rápido que los hyperscalers tradicionales.",
 "Nebius": "Neocloud europeo (heredero de Yandex NV, sede en Ámsterdam) que construye clusters de GPUs NVIDIA a gran escala para entrenamiento e inferencia de IA. Importa como alternativa full-stack europea a los hyperscalers, con respaldo e inversión de NVIDIA y contratos de capacidad con laboratorios como Microsoft/Anthropic.",
 "Equinix": "Mayor REIT de data centers neutrales del mundo, con más de 270 centros en 35 países. Su moat es el tejido de interconexión: los puntos donde clouds, carriers y empresas se conectan entre sí pasan físicamente por Equinix, lo que lo hace infraestructura crítica para el tráfico de IA y cloud.",
 "DigitalRealty": "REIT global de data centers con más de 300 instalaciones que arrienda capacidad a hyperscalers y neoclouds. Importa porque el cuello de botella de la IA es hoy espacio y energía en data centers, y Digital Realty controla terreno, permisos y megavatios que los clouds no pueden replicar rápido.",
 "OpenAI": "Laboratorio de IA de frontera creador de ChatGPT y los modelos GPT, el mayor consumidor privado de cómputo del mundo. Sus megacontratos (Microsoft, Oracle, proyecto Stargate) mueven decenas de miles de millones y definen la demanda de toda la cadena de chips y data centers.",
 "Anthropic": "Laboratorio de IA de frontera creador de Claude, enfocado en seguridad y en el mercado empresarial/de código. Importa como segundo gran comprador de cómputo (Amazon y Google son inversores y proveedores), y ancla la demanda de los chips Trainium de AWS y TPUs de Google.",
 "xAI": "Laboratorio de IA de Elon Musk creador de Grok, integrado con SpaceX y X. Destaca por construir sus propios superclusters (Colossus, en Memphis) a velocidad récord, convirtiéndose en uno de los mayores compradores directos de GPUs NVIDIA y de turbinas de gas para alimentarlas.",
 "Mistral": "Laboratorio francés de IA, campeón europeo de modelos open-weight y de la 'IA soberana'. Importa como la principal apuesta de Europa para no depender de labs estadounidenses o chinos, con respaldo de NVIDIA, ASML y el Estado francés, y foco en clientes empresariales y de defensa europeos.",
 "Meta": "Hyperscaler de consumo (Facebook, Instagram, WhatsApp) y laboratorio de IA con la familia LLaMA. Importa por su capex masivo en data centers y GPUs —uno de los mayores clientes de NVIDIA— y porque sus modelos abiertos fijan el precio de referencia (gratis) para el resto del mercado.",
 "DeepSeek": "Laboratorio chino de IA (spin-off del hedge fund High-Flyer) famoso por alcanzar rendimiento de frontera con una fracción del cómputo occidental. Importa porque demostró que las restricciones de chips a China no impiden modelos competitivos, sacudiendo la tesis de inversión de toda la cadena en enero de 2025.",
 "Qwen": "Familia de modelos de Alibaba, los open-weight más descargados y derivados del mundo. Importa porque da a China influencia sobre el ecosistema global de modelos abiertos y ancla la nube de Alibaba; es la vía invertible (BABA) a la IA china.",
 "Tesla": "Fabricante de vehículos eléctricos que se ha convertido en plataforma de IA física: conducción autónoma (FSD/robotaxi), el humanoide Optimus y almacenamiento de energía. Importa porque integra verticalmente chips propios (Dojo/AI5), datos de flota masivos y manufactura, siendo la mayor apuesta cotizada en robótica.",
 "Figure": "Startup estadounidense de robots humanoides, la mejor financiada del sector (valorada en decenas de miles de millones tras rondas con Microsoft, NVIDIA y fondos soberanos). Importa por su modelo propio Helix de visión-lenguaje-acción y sus pilotos de manufactura con BMW, que la posicionan para el mercado laboral físico.",
 "BostonDynamics": "Pionero de la robótica dinámica (Atlas, Spot), hoy subsidiaria de Hyundai. Importa porque posee décadas de ventaja en control y hardware de locomoción, y su nuevo Atlas eléctrico apunta a logística y fábricas de Hyundai como primer cliente ancla.",
 "OneX": "Empresa noruega de robots humanoides (NEO) orientados al hogar, respaldada por OpenAI y EQT. Importa porque es la primera en apostar por el mercado doméstico masivo con robots suaves y seguros, y sirve de vía de OpenAI hacia la IA encarnada.",
 "Unitree": "Fabricante chino de robots cuadrúpedos (Go2, B2) y humanoides (G1, H2) a precios disruptivos —humanoides desde ~16.000 dólares— gracias a integración vertical de motores y actuadores. Importa porque comoditiza el hardware robótico global y su IPO en el STAR Market será el primer gran listado puro de humanoides.",
 "Apptronik": "Startup de Austin que desarrolla el humanoide Apollo para logística e industria, con inversión de Google y pilotos con Mercedes-Benz y GXO. Es uno de los principales candidatos a llevar robots humanoides de propósito general al trabajo industrial real en EEUU.",
 "Palantir": "Software de análisis de datos e IA para gobiernos y empresas: Gotham para defensa/inteligencia y la plataforma AIP para desplegar LLMs sobre datos operativos. Su moat es la ontología que conecta datos con decisiones y su posición atrincherada en el Pentágono y aliados de EEUU.",
 "CrowdStrike": "Líder en ciberseguridad cloud-native con la plataforma Falcon, que usa IA sobre telemetría masiva de endpoints para detectar amenazas. Es la capa de seguridad de facto de miles de grandes empresas, crítica a medida que la IA amplifica los ciberataques.",
 "Snowflake": "Data cloud empresarial donde miles de compañías centralizan y comparten sus datos; con Cortex lleva LLMs directamente a esos datos. Importa porque la IA generativa corporativa aterriza donde ya viven los datos, y Snowflake es esa capa neutral entre AWS, Azure y GCP.",
 "Huawei": "Conglomerado chino sancionado por EEUU: líder en equipos de telecom, dueño de HiSilicon (diseño de chips) y de los aceleradores Ascend, la alternativa china a Nvidia. Es la punta de lanza de la autosuficiencia tecnológica de China y el principal cliente de la fabricación avanzada de SMIC.",
 "MediaTek": "Segundo diseñador fabless del mundo por volumen: SoCs Dimensity para smartphones Android, chips para IoT, TV y conectividad, todo fabricado en TSMC. Importa como proveedor dominante del segmento medio de móviles y ahora socio de Nvidia en chips para PC y automoción.",
 "Groq": "Fundada por un ex-creador de la TPU de Google, diseña la LPU, un chip especializado en inferencia de LLMs con latencia extremadamente baja. Es una de las alternativas más serias a Nvidia en inferencia, con megaacuerdos como el datacenter de IA en Arabia Saudí (Aramco/Humain).",
 "SambaNova": "Startup full-stack de IA: chip RDU de dataflow reconfigurable más software y modelos listos para empresas y gobiernos. Compite con Nvidia ofreciendo inferencia rápida de modelos grandes como sistema completo, sin que el cliente arme su propia infraestructura.",
 "WesternDigital": "Tras separar su negocio NAND en SanDisk, se concentra en discos duros y SSD empresariales de alta capacidad. Importa porque los datacenters de IA necesitan almacenamiento masivo barato para datasets y checkpoints, y WD es junto a Seagate uno de los dos únicos proveedores de HDD de gran capacidad.",
 "Naver": "El 'Google de Corea': buscador, cloud y el LLM propio HyperCLOVA X, el modelo soberano coreano optimizado para su idioma. Importa como ejemplo de IA soberana no estadounidense, gran comprador de GPUs y socio de Samsung en chips de inferencia.",
 "SoftBank": "Conglomerado inversor japonés de Masayoshi Son: dueño de ARM, líder de la megaronda de OpenAI y socio del proyecto Stargate de datacenters de IA en EEUU. Es el mayor canal de capital hacia la infraestructura de IA, uniendo ARM, OpenAI y ambiciones propias en chips (Izanagi/Ampere).",
 "Xiaomi": "Gigante chino de electrónica de consumo (nº3 mundial en smartphones) que ya diseña su propio SoC de 3nm (XRING O1) y fabrica vehículos eléctricos (SU7). Importa como prueba de que los grandes de hardware chinos avanzan hacia silicio propio pese a las restricciones de EEUU.",
 "BMW": "Fabricante premium alemán y primer cliente industrial de los humanoides Figure 02, probados en su planta de Spartanburg. Importa como caso de validación temprana: si los humanoides funcionan en una línea automotriz exigente, se abre el mercado industrial masivo.",
 "Hyundai": "Tercer fabricante mundial de automóviles y propietario de Boston Dynamics, la empresa de robótica más avanzada en locomoción (Atlas, Spot). Es la apuesta coreana por la IA física: capital automotriz masivo detrás de la comercialización de robots humanoides.",
 "SAIC": "Mayor grupo automotor de China (~5 millones de coches al año), pionero en integrar humanoides de Unitree en líneas de producción reales. Importa como escaparate de la estrategia china de adoptar robots humanoides a escala fabril antes que Occidente."
};
if (typeof NODE_META !== 'undefined') {
  for (var _kd in DESC_FILL) {
    NODE_META[_kd] = NODE_META[_kd] || {};
    if (!NODE_META[_kd].desc) NODE_META[_kd].desc = DESC_FILL[_kd];
  }
}
window.DESC_FILL = DESC_FILL;
