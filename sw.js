...
const CACHE = 'khipu-finance-v131';
...
const SHELL = ['/', '/app.html',
  ...
  '/engine/timeline3d.js', '/engine/khipu_lang.js', '/engine/guide.js', '/engine/xray.js', '/engine/insights.js', '/engine/statematrix.js', '/engine/livesim.js', '/engine/layers.js', '/engine/brief.js', '/engine/compare.js', '/engine/matrixview.js', '/engine/nav4.js', '/engine/cockpit.js', '/engine/live.js', '/engine/localcharts.js', '/engine/fincard.js', '/engine/termdata.js', '/engine/explain.js', '/engine/crypto.js', '/engine/portfolios.js',
